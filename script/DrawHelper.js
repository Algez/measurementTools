...
var DrawHelper = (function () {
  ...
  _.PolylinePrimitive = (function () {
    ...
    _.prototype.setClampToGround = function (clampToGround) {
      this.setAttribute("clampToGround", clampToGround);
    };
    ...
    _.prototype.getClampToGround = function () {
      return this.getAttribute("clampToGround");
    };
    ...
    function _(drawHelper, options) {
      ...
      addIcon("polyline", options.polylineIcon, "画线", function () {
        drawHelper.startDrawingPolyline({
          clampToGround: true, // Enable clamping to ground
