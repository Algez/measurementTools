  ...
  function () {
      ...
      o.Marker.include(a),
        ...
        (o.Control.Zoom = o.Control.extend({
          options: {
            position: "topleft",
            zoomInText: "+",
            /*zoomInTitle:"Zoom in"*/ zoomInTitle: "放大",
            zoomOutText: "-",
            /*zoomOutTitle:"Zoom out"*/ zoomOutTitle: "缩小",
          },
          onAdd: function (t) {
    ...
    define("ViewModels/DistanceLegendViewModel", [
      ...
      var distances = [
        ...
        2e4, 3e4, 5e4, 1e5, 2e5, 3e5, 5e5, 1e6, 2e6, 3e6, 5e6, 1e7, 2e7, 3e7,
        5e7,
      ];
    ...
    define("ViewModels/ResetViewNavigationControl", [
      ...
      var ResetViewNavigationControl = function (terria) {
        ...
        /*this.name="Reset View";*/ this.name = "地图复位";
    ...
    define("ViewModels/ZoomNavigationControl", [
      ...
      var ZoomNavigationControl = function (terria, zoomIn) {
        NavigationControl.apply(this, arguments);
        /*this.name="Zoom "+(zoomIn?"In":"Out");*/ if (zoomIn) {
          this.name = "放大";
        } else {
          this.name = "缩小";
        }
    ...
    define("ViewModels/NavigationViewModel", [
      ...
      NavigationViewModel.prototype.handleDoubleClick = function (
        viewModel,
        e
      ) {
